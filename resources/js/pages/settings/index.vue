...
import { ShieldCheck, UserCircle, Palette, Users } from 'lucide-vue-next'; // Beispiel-Icons
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
      <div class="mb-8">
        ...
        <p class="mt-1 text-lg text-gray-600 dark:text-gray-400">
          Verwalte hier deine Account-Einstellungen und Präferenzen.
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div
          ...
          :key="link.href"
          class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
