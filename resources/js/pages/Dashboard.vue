...
import { Head, Link, router } from '@inertiajs/vue3'; // usePage ist schon da
import { ref } from 'vue'; // ref für usersList, computed für abgeleitete Zustände
...
<template>
    ...
    <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
        ...
        <div class="relative min-h-[calc(100vh-20rem)] flex-1 rounded-xl border border-sidebar-border/70 p-4 dark:border-sidebar-border md:min-h-min">
            <PlaceholderPattern v-if="isLoadingUsers && !localUserFetchError" />

            <div v-if="localUserFetchError" class="rounded border border-red-400 bg-red-100 p-4 text-red-500">
            ...
            <div v-if="!isLoadingUsers && !localUserFetchError && usersList.length > 0">
                <h2 class="mb-3 text-xl font-semibold dark:text-white">Benutzerliste (Initial geladen)</h2>
