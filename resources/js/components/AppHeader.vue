...
// =============================================================================
// NEUE, VERBESSERTE LOGIK FÜR EASTER EGG
// =============================================================================
...
// Wählt einen zufälligen Text und setzt ihn
...
function scheduleGhostlyReappearance() {
    ...
    ghostTimeoutId = window.setTimeout(() => {
        setRandomGhostText(); // Wählt einen neuen Text, bevor der Button erscheint
...
// Beobachtet den Dark-Mode und steuert die initiale Sichtbarkeit
onMounted(() => {
    ...
    if (!wasHidden) {
        if (Math.random() > 0.5) {
            setRandomGhostText(); // Setzt einen initialen zufälligen Text
            showGhostButton.value = true;
        }
    } else {
        scheduleGhostlyReappearance();
...
/* ======================================= */
/* NEUER, EINFACHERER GLITCH-EFFEKT        */
/* ======================================= */
