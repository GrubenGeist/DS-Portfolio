...
use Illuminate\Http\JsonResponse;           // Um Fehler aufzuschreiben (Logging)
use Illuminate\Support\Facades\Log;          // Um E-Mails zu versenden
use Illuminate\Support\Facades\Mail;             // Um eine Antwort im JSON-Format zu geben (gut für Vue.js)
